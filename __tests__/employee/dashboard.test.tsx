...
describe("EmployeeDashboard - E2E Tests", () => {
    ...
    describe("Loading States", () => {
        // Leave loading states removed: leave info is no longer on dashboard
    });

    describe("Error States", () => {
        // Leave error states removed: leave info is no longer on dashboard
    });

    describe("Leave Statistics Overview", () => {
        // Leave statistics overview removed: leave info is no longer on dashboard
